...
class Config:
    ...
    model_weight: float = _float("MODEL_WEIGHT", 0.1)
    moneyline_market_weight: float = _float("MONEYLINE_MARKET_WEIGHT", 0.9)
    live_model_weight: float = _float("LIVE_MODEL_WEIGHT", 0.1)
    live_moneyline_market_weight: float = _float("LIVE_MONEYLINE_MARKET_WEIGHT", 0.9)
